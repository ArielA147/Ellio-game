...
//	private Player player2;
    ...
    public void init() {
        ...
        for (int i = 0; i < playersNum; ++i) {
            players.add(new Player(x, GameMainActivity.GAME_HEIGHT - 45 - PLAYER_HEIGHT, PLAYER_WIDTH, PLAYER_HEIGHT));
            x += players_cup;
        }
//		Player player1 = new Player(160, GameMainActivity.GAME_HEIGHT - 45 -PLAYER_HEIGHT, PLAYER_WIDTH, PLAYER_HEIGHT);
//		Player player2 = new Player(140, GameMainActivity.GAME_HEIGHT - 45 -PLAYER_HEIGHT, PLAYER_WIDTH, PLAYER_HEIGHT);
...
//		players.add(player2);
    ...
    public void update(float delta) {
        ...
        for (Player player : players) {
            isOneALive = isOneALive && !player.isAlive();
        }
        if (isOneALive) {
    ...
    public Player addPlayer(){
        Player newPlayer = new Player(x, GameMainActivity.GAME_HEIGHT - 45 - PLAYER_HEIGHT, PLAYER_WIDTH, PLAYER_HEIGHT);
