...
public class AIState extends State {
    ...
    public void init() {
        ...
        computer = new Player(50, GameMainActivity.GAME_HEIGHT - 45 - PLAYER_HEIGHT, PLAYER_WIDTH, PLAYER_HEIGHT);
        players.add(player);
    ...
    public void update(float delta) {
        ...
        if (isOneALive) {
            GameOverState newState = new GameOverState(playerScore / 100);
            if (player.isAlive()){
