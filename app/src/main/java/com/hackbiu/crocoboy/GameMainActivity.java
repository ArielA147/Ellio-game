...
import com.hackbiu.accessibility.GooglyFaceTracker;
import com.hackbiu.accessibility.ui.camera.CameraSourcePreview;
import com.hackbiu.accessibility.ui.camera.GraphicOverlay;
	...
	public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
		...
		if (grantResults.length != 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
			...
			if (Build.VERSION.SDK_INT >= 11) {
				GameMainActivity.this.recreate();
			} else {
				GameMainActivity.this.finish();
				GameMainActivity.this.startActivity(GameMainActivity.this.getIntent());
			}
			createCameraSource();
			return;
		}
